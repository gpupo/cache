...
### Cache\Driver\ApcDriver


- [ ] Armazena informacao
- [ ] Possui opcoes personalizadas
- [ ] Armazena objeto 

### Cache\Driver\DriverAbstract


- [x] Serializa informacao

### Cache\Driver\MemcachedDriver


- [x] Possui client memcached
- [ ] Armazena informacao
- [x] Possui opcoes personalizadas
- [ ] Armazena objeto 

### Cache\ObjectWithCacheItemPool
