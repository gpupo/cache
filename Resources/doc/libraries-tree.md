...
`--php >=5.3.0
fig/cache-util 1.0.x-dev Useful utility classes and traits for implementing the PSR cache standard
|--php >=5.4.0
`--psr/cache ^1.0.0
   `--php >=5.3.0
fig/cache-util dev-master Useful utility classes and traits for implementing the PSR cache standard
|--php >=5.4.0
`--psr/cache ^1.0.0
   `--php >=5.3.0
